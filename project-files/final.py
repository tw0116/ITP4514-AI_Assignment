...
sample_dataset = {
    ...
    'lai king/twl': [['kwai fong/twl', 2.0], ['mei foo/twl', 2.0], ['lai king/tcl', 2.0]],# <interchange>
    ...
    'prince edward/twl': [['sham shui po/twl', 2.0], ['mong kok/twl', 2.0], ['prince edward/ktl', 2.0]],# <interchange>
    'mong kok/twl': [['prince edward/twl', 2.0], ['yau ma tei/twl', 2.0], ['mong kok/ktl', 2.0]],# <interchange>
    'yau ma tei/twl': [['mong kok/twl', 2.0], ['jordan/twl', 2.0], ['yau ma tei/ktl', 2.0]],# <interchange>
    'jordan/twl': [['yau ma tei/twl', 2.0], ['tsim sha tsui/twl', 2.0]],
    'tsim sha tsui/twl': [['jordan/twl', 2.0], ['admiralty/twl', 2.0]],
    'admiralty/twl': [['tsim sha tsui/twl', 2.0], ['central/twl', 2.0], ['admiralty/il', 2.0]],# <interchange>
    'central/twl': [['admiralty/twl', 2.0], ['central/il', 2.0]],# <interchange>
    ...
    'lai king/tcl': [['tsing yi/tcl', 3.3], ['nam cheong/tcl', 3.3], ['lai king/twl', 2.0]],# <interchange>
    ...
    'hong kong/tcl': [['kowloon/tcl', 3.3], ['central/il', 2.0]],# <interchange> 

    'whampoa/ktl': [['ho man tin/ktl', 4.2]],
    'ho man tin/ktl': [['whampoa/ktl', 4.2], ['yau ma tei/ktl', 2.0]],
    'yau ma tei/ktl': [['ho man tin/ktl', 2.0], ['mong kok/ktl', 2.0], ['yau ma tei/twl', 2.0]],# <interchange>
    'mong kok/ktl': [['yau ma tei/ktl', 2.0], ['prince edward/ktl', 2.0], ['mong kok/twl', 2.0]],# <interchange>
    'prince edward/ktl': [['mong kok/ktl', 2.0], ['shek kip mei/ktl', 2.0], ['prince edward/twl', 2.0]],# <interchange>
    ...
    'yau tong/ktl': [['lam tin/ktl', 2.0], ['tiu keng leng/ktl', 2.0], ['yau tong/tkol', 2.0]],# <interchange> 
    'tiu keng leng/ktl': [['yau tong/ktl', 2.0], ['tiu keng leng/tkol', 2.0]],# <interchange> 
    ...
    'central/il': [['sheung wan/il', 1.9], ['admiralty/il', 1.9], ['central/twl', 2.0]],# <interchange>
    'admiralty/il': [['central/il', 1.9], ['wan chai/il', 1.9], ['admiralty/twl', 2.0]],# <interchange>
    ...
    'north point/il': [['fortress hill/il', 1.9], ['quarry bay/il', 1.9], ['north point/tkol', 2.0]],# <interchange>
    'quarry bay/il': [['north point/il', 1.9], ['tai koo/il', 1.9], ['quarry bay/tkol', 2.0]],# <interchange>
    ...
    'tiu keng leng/tkol': [['tseung kwan o/tkol', 4.2], ['yau tong/tkol', 4.2], ['tiu keng leng/ktl', 2.0]],# <interchange>
    'yau tong/tkol': [['tiu keng leng/tkol', 4.2], ['quarry bay/tkol', 4.2], ['yau tong/ktl', 2.0]],# <interchange>
    'quarry bay/tkol': [['yau tong/tkol', 4.2], ['north point/tkol', 4.2], ['quarry bay/il', 2.0]],# <interchange>
    'north point/tkol': [['quarry bay/tkol', 4.2], ['north point/il', 2.0]]# <interchange>
}
